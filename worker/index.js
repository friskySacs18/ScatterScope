...
</style></head><body><div class="signal-sweep" aria-hidden="true"></div><nav class="nav wrap"><a class="logo" href="/"><i aria-hidden="true"></i>scope</a><a href="#callerDesk">CALLERS</a><a href="/account">TRADING ACCOUNT ↗</a><a href="/portfolio">PHANTOM OPTION</a><span class="pill">PAPER RESEARCH · 0 SOL LIVE</span></nav><main><section class="hero"><div class="scope-ring" aria-hidden="true"></div><div class="signal-horn" aria-hidden="true"><svg viewBox="0 0 720 720" role="presentation"><defs><linearGradient id="brass" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f7dfa6"/><stop offset=".3" stop-color="#b5854b"/><stop offset=".55" stop-color="#4b3d30"/><stop offset=".77" stop-color="#d1a668"/><stop offset="1" stop-color="#614b37"/></linearGradient><linearGradient id="darkHorn" x1="0" y1="0" x2="1" y2=".7"><stop offset="0" stop-color="#122b32"/><stop offset=".55" stop-color="#071219"/><stop offset="1" stop-color="#41606a"/></linearGradient><radialGradient id="bell"><stop offset="0" stop-color="#071016"/><stop offset=".52" stop-color="#162b31"/><stop offset=".79" stop-color="#372f2b"/><stop offset=".9" stop-color="#e0ae6a"/><stop offset="1" stop-color="#4c3d31"/></radialGradient><filter id="glow"><feGaussianBlur stdDeviation="10"/></filter></defs><g class="horn-waves" fill="none" stroke="#b6e6e1" stroke-width="2"><path d="M495 165a230 230 0 0 1 0 390"/><path d="M535 100a307 307 0 0 1 0 520"/><path d="M584 40a388 388 0 0 1 0 640"/></g><ellipse cx="360" cy="360" rx="258" ry="258" fill="none" stroke="#c1a272" stroke-opacity=".22"/><path d="M141 307 312 241 462 169v381L312 479 141 413Z" fill="url(#brass)" stroke="#f0cf98" stroke-opacity=".7" stroke-width="3"/><path d="M162 314 310 264 407 224v272L310 456 162 406Z" fill="url(#darkHorn)"/><path d="M235 440 296 467 278 560 217 555Z" fill="url(#brass)" stroke="#c9a472" stroke-width="3"/><rect x="207" y="536" width="95" height="23" rx="9" fill="#24373b" stroke="#bb955e"/><path d="M106 328q-21 13-21 32t21 33l62 21V307Z" fill="#a27849" stroke="#dfb57d" stroke-width="3"/><ellipse cx="448" cy="359" rx="93" ry="192" fill="url(#bell)" stroke="#f1d0a0" stroke-width="7"/><ellipse cx="450" cy="359" rx="67" ry="162" fill="#0a171d" stroke="#8ab2ac" stroke-opacity=".65" stroke-width="3"/><ellipse cx="451" cy="359" rx="34" ry="112" fill="#071016" stroke="#d8b475" stroke-opacity=".55"/><path d="M357 184c75-26 147 77 164 175" fill="none" stroke="#fff2d0" stroke-opacity=".65" stroke-width="4"/><circle cx="450" cy="358" r="6" fill="#e9c383" filter="url(#glow)"/><circle cx="450" cy="358" r="3" fill="#f5e1bb"/></svg><span class="horn-label">CALL / SIGNAL 001</span></div><div class="wrap"><div class="eyebrow">SCOPE / PUBLIC CALLS, PRIVATE DECISIONS</div><h1>Follow the call.<br><em>Audit the edge.</em></h1><p>Add the Pump.fun callers you follow. Their new Callouts appear in your feed while this page is open.</p><form id="heroCallerForm" class="hero-quick"><label for="heroCaller" class="mono" style="position:absolute;left:-9999px">Pump username, join link or wallet</label><input id="heroCaller" placeholder="@username, pump.fun/join/… or wallet" maxlength="260" required><button type="submit">ADD TO WATCHLIST ↗</button></form><small class="hero-quick-note">Free setup · no wallet or token burn during prelaunch</small><div class="actions"><a class="btn primary" href="/account">OPEN SCOPE TRADING ACCOUNT ↗</a><a class="btn" href="/account#autoRules">SET TRADE RULES ↗</a></div><span class="hero-coordinate mono">SIGNAL FIRST / CAPITAL LAST</span></div></section><section class="section wrap" id="callerDesk"><div class="section-head"><div><span class="eyebrow">01 / CALLER FIELD</span><h2>Make your own<br>watchlist.</h2></div><p>Follow a caller, see their published coin, and set up how much you want to spend. Live orders remain locked until the trading account can execute safely.</p></div><div class="workbench"><div><span class="number">YOUR FIELD / THIS DEVICE</span><h3>Choose who to study.</h3><p>Paste a Pump username, profile link, join link, or Solana wallet. This browser checks your list while the page is open.</p><form class="caller-form" id="callerForm"><label for="callerProfile" class="mono" style="position:absolute;left:-9999px">Pump username, profile or join link, or wallet address</label><input id="callerProfile" placeholder="@username, pump.fun/join/…, or wallet" required maxlength="260"><button type="submit" class="btn primary">ADD CALLER</button></form><p id="callerStatus" class="status" role="status">No wallet, burn, or live trading is required for setup.</p><div id="watchlist" class="watchlist" aria-live="polite"></div><div class="live-watch" aria-label="Callout watch"><span class="eyebrow">LIVE SOURCE / PAPER OBSERVATION</span><h4>Watching your callers</h4><p id="calloutMonitorStatus" role="status">Add a caller to set up your watchlist. Callout monitoring begins when you add a caller and keep this page open.</p><div id="calloutMonitorList" aria-live="polite"></div><p>Calls from your selected profiles appear here while the page is open. No order, fill, or profit is claimed, and live spending is locked.</p></div> </div><div><span class="number">NEXT STEP / TRADING ACCOUNT</span><h3>Your setup.</h3><p>Create a dedicated Scope trading account to deposit SOL and trade Pump tokens manually today. Your saved callers and sell targets prepare for automatic trades once the signer and order controls are verified.</p><a class="btn primary" href="/account">OPEN TRADING ACCOUNT ↗</a><p style="margin-top:24px">Prefer to approve each trade in Phantom? <a href="/portfolio">Use the Phantom portfolio ↗</a></p><div class="gate"><span>Callout feed</span><b>LIVE WHILE OPEN</b></div><div class="gate"><span>Automatic orders</span><b>LOCKED</b></div></div></div></section></main><footer class="wrap"><span><a href="/launch-research" style="color:inherit;text-decoration:none;opacity:.68">Research archive</a></span><span>SCOPE / EVIDENCE BEFORE EXECUTION</span><span><a href="https://github.com/friskySacs18/ScatterScope" target="_blank" rel="noopener noreferrer">FRISKY GITHUB ↗</a> · RESEARCH STAGE</span></footer><script>
